...
class EnergyDataSource(BaseDataSource):
    ...
    def get_metadata(self) -> SourceMetadata:
        return SourceMetadata(
            ...
            supported_fields=[
                "timestamp", "region", "demand_mwh", "net_generation_mwh",
                "interchange_mwh", "peak_demand_mwh", "carbon_intensity_gco2_kwh",
                "fuel_mix_coal_pct", "fuel_mix_gas_pct", "fuel_mix_nuclear_pct",
                "fuel_mix_wind_pct", "fuel_mix_solar_pct", "fuel_mix_hydro_pct",
            ],
        ...
        placeholder_records = [
            {
                ...
                "fuel_mix": {
                    "coal": None, "gas": None, "nuclear": None,
                    "wind": None, "solar": None, "hydro": None,
                },
                "_placeholder": True,
            }
