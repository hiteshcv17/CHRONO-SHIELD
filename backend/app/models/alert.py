...
class PrioritizedAlertRecord(Base):
    ...
    )  # If active cooldown block
    escalation_level = Column(
        Integer, nullable=False, default=0
    )  # 0 = none, 1 = SLA breach tier 1
